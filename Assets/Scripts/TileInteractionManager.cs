...
public class TileInteractionManager : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        tileInteractions.Add("House_House", 0); // Houses next to each other are nuterial
        tileInteractions.Add("House_Park", 1);  // Houses near parks are good
        tileInteractions.Add("House_Dump", -1); //Houses near Dumps are bad
        ...
        tileInteractions.Add("Dump_Dump", 1);
        tileInteractions.Add("Factory_Factory", 1);
        tileInteractions.Add("Park_Park", 0);
        tileInteractions.Add("Shop_Shop", 1);
        tileInteractions.Add("School_School", 0);
        tileInteractions.Add("School_Shop", 0);
        tileInteractions.Add("House_School", 1);
        tileInteractions.Add("Dump_School", -1);
        tileInteractions.Add("Factory_School", -1);
        tileInteractions.Add("Park_School", 1);
        tileInteractions.Add("Shop_House", 1);
        tileInteractions.Add("Shop_Dump", -1);
        tileInteractions.Add("Shop_Factory", 0);
        tileInteractions.Add("Shop_Park", -1);
